...
public class Botones extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imagen = new Image(getClass().getResourceAsStream("/img/anuel.jpeg"), 50, 50, true, true);
            btTextoImagen.setGraphic(new ImageView(imagen));
            btTextoImagen.setText("UY");
            btTextoImagen.setGraphicTextGap(20);
            btTextoImagen.setFont(Font.font("Ani", 30));

            imagen = new Image(getClass().getResourceAsStream("/img/microfono.jpg"), 60, 60, true, true);
